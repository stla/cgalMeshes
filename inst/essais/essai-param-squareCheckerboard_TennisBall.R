...
mesh1$isotropicRemeshing(0.0025, iterations = 3, relaxSteps = 2)
mesh2$isotropicRemeshing(0.0025, iterations = 3, relaxSteps = 2)


# compute mesh1 parameterization ####
UV <- mesh1$parameterization(method = "DCP", UVborder = "square")
...
snapshot3d(sprintf("TennisBall_checkerboard.png"), webshot = FALSE)
