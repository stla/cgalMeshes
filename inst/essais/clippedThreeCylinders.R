...
mesh1$assignFaceColors("firebrick")
mesh2$assignFaceColors("forestgreen")
mesh3$assignFaceColors("midnightblue")
...
blue <- which(mesh1$getFaceColors() == "midnightblue")
mm1 <- mesh1$filterMesh(blue)
mblue <- mm1[[1]]
m2    <- mm1[[2]]

red <- which(m2$getFaceColors() == "firebrick")
...
shade3d(rm1, meshColor = "faces", specular = "darkred")
shade3d(rm2, meshColor = "faces", specular = "darkgreen")
shade3d(rm3, meshColor = "faces", specular = "darkblue")
